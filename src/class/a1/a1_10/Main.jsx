...
export function A1_10() {
	return (<>
		...
		<div>estas reglas sirven para hablar de más de 1 cosa o para hablar en 3ra persona singular en presente(cuando hablas de otra persona u cosa y esa persona u cosa es solo 1). No es necesario memorizar las siguientes reglas, estar conciente de ellas es suficiente!</div>
